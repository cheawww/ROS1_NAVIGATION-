...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_follower_SOURCE_PREFIX /home/vladilena/catkin_ws/src/turtlebot_apps/turtlebot_follower)
  set(turtlebot_follower_DEVEL_PREFIX /home/vladilena/catkin_ws/devel)
  ...
  set(turtlebot_follower_INSTALL_PREFIX /home/vladilena/catkin_ws/install)
...
if(NOT "/home/vladilena/catkin_ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/turtlebot_apps " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/turtlebot_apps' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'turtlebot_follower' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'turtlebot_follower' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vladilena/catkin_ws/src/turtlebot_apps/turtlebot_follower/${idir}'.  ${_report}")
    endif()
    _list_append_unique(turtlebot_follower_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "turtlebot_follower")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT turtlebot_follower_NUM_DUMMY_TARGETS)
      set(turtlebot_follower_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::turtlebot_follower::wrapped-linker-option${turtlebot_follower_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR turtlebot_follower_NUM_DUMMY_TARGETS "${turtlebot_follower_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::turtlebot_follower::wrapped-linker-option${turtlebot_follower_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND turtlebot_follower_LIBRARIES "${interface_target_name}")
...
set(depends "nodelet;roscpp;visualization_msgs;turtlebot_msgs;depth_image_proc;dynamic_reconfigure")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${turtlebot_follower_dep}_FOUND)
      find_package(${turtlebot_follower_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${turtlebot_follower_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(turtlebot_follower_EXPORTED_TARGETS ${${turtlebot_follower_dep}_EXPORTED_TARGETS})
endforeach()
