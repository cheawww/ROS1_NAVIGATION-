...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_gazebo_SOURCE_PREFIX /home/vladilena/catkin_ws/src/turtlebot_simulator/turtlebot_gazebo)
  set(turtlebot_gazebo_DEVEL_PREFIX /home/vladilena/catkin_ws/devel)
  ...
  set(turtlebot_gazebo_INSTALL_PREFIX /home/vladilena/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vladilena/catkin_ws/src/turtlebot_simulator/turtlebot_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT turtlebot_gazebo_NUM_DUMMY_TARGETS)
      set(turtlebot_gazebo_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::turtlebot_gazebo::wrapped-linker-option${turtlebot_gazebo_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR turtlebot_gazebo_NUM_DUMMY_TARGETS "${turtlebot_gazebo_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::turtlebot_gazebo::wrapped-linker-option${turtlebot_gazebo_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND turtlebot_gazebo_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(turtlebot_gazebo_EXPORTED_TARGETS ${${turtlebot_gazebo_dep}_EXPORTED_TARGETS})
endforeach()
