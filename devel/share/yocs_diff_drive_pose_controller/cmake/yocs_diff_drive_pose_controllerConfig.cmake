...
if("TRUE" STREQUAL "TRUE")
  set(yocs_diff_drive_pose_controller_SOURCE_PREFIX /home/vladilena/catkin_ws/src/yujin_ocs/yocs_diff_drive_pose_controller)
  set(yocs_diff_drive_pose_controller_DEVEL_PREFIX /home/vladilena/catkin_ws/devel)
  ...
  set(yocs_diff_drive_pose_controller_INSTALL_PREFIX /home/vladilena/catkin_ws/install)
...
if(NOT "/home/vladilena/catkin_ws/src/yujin_ocs/yocs_diff_drive_pose_controller/include " STREQUAL " ")
  set(yocs_diff_drive_pose_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/vladilena/catkin_ws/src/yujin_ocs/yocs_diff_drive_pose_controller/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yocs_diff_drive_pose_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vladilena/catkin_ws/src/yujin_ocs/yocs_diff_drive_pose_controller/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT yocs_diff_drive_pose_controller_NUM_DUMMY_TARGETS)
      set(yocs_diff_drive_pose_controller_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::yocs_diff_drive_pose_controller::wrapped-linker-option${yocs_diff_drive_pose_controller_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR yocs_diff_drive_pose_controller_NUM_DUMMY_TARGETS "${yocs_diff_drive_pose_controller_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::yocs_diff_drive_pose_controller::wrapped-linker-option${yocs_diff_drive_pose_controller_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND yocs_diff_drive_pose_controller_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(yocs_diff_drive_pose_controller_EXPORTED_TARGETS ${${yocs_diff_drive_pose_controller_dep}_EXPORTED_TARGETS})
endforeach()
