...
if("TRUE" STREQUAL "TRUE")
  set(yocs_virtual_sensor_SOURCE_PREFIX /home/vladilena/catkin_ws/src/yujin_ocs/yocs_virtual_sensor)
  set(yocs_virtual_sensor_DEVEL_PREFIX /home/vladilena/catkin_ws/devel)
  ...
  set(yocs_virtual_sensor_INSTALL_PREFIX /home/vladilena/catkin_ws/install)
...
if(NOT "/home/vladilena/catkin_ws/src/yujin_ocs/yocs_virtual_sensor/include;/usr/include " STREQUAL " ")
  set(yocs_virtual_sensor_INCLUDE_DIRS "")
  set(_include_dirs "/home/vladilena/catkin_ws/src/yujin_ocs/yocs_virtual_sensor/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yocs_virtual_sensor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vladilena/catkin_ws/src/yujin_ocs/yocs_virtual_sensor/${idir}'.  ${_report}")
    endif()
    _list_append_unique(yocs_virtual_sensor_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libboost_system.so.1.71.0")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT yocs_virtual_sensor_NUM_DUMMY_TARGETS)
      set(yocs_virtual_sensor_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::yocs_virtual_sensor::wrapped-linker-option${yocs_virtual_sensor_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR yocs_virtual_sensor_NUM_DUMMY_TARGETS "${yocs_virtual_sensor_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::yocs_virtual_sensor::wrapped-linker-option${yocs_virtual_sensor_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND yocs_virtual_sensor_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(yocs_virtual_sensor_EXPORTED_TARGETS ${${yocs_virtual_sensor_dep}_EXPORTED_TARGETS})
endforeach()
